...
import { TrendingUp, Brain, BarChart2, ShieldCheck, Zap, Globe, IndianRupee, Building2 } from 'lucide-react'
...
const FEATURES = [
  ...
  { icon: TrendingUp, title: 'Buy/Sell/Hold Engine', desc: 'Multi-factor AI recommendation combining trend analysis, news sentiment, P/E ratio, and beta risk.' },
...
const TICKERS = [
  ...
  'WIPRO', 'SBIN', 'BAJFINANCE', 'ADANIENT', 'TATAMOTORS',
  'RELIANCE', 'TCS', 'INFY', 'HDFCBANK', 'ICICIBANK',
]
